              ...
              <ul className="text-sm">
                <li>
                  ...
                  viewBox="0 0 16 16"
                    ...
                    <span>Software enginner Jobs</span>
                  </Link>
                </li>
                <li>
                  <Link
                ...
                <li>
                  ...
                  viewBox="0 0 16 16"
                    ...
                    <span>
                      ...
                      <span className="text-gray-600 dark:text-gray-400">Inter Software enginner jobs</span>
                    </span>
                  </Link>
                </li>
                <li>
                  ...
                  viewBox="0 0 16 16"
                    ...
                    <span>
                      <span className="font-medium">Messages</span> -{' '}
                      <span className="text-gray-600 dark:text-gray-400">Driver Jobs </span>
                    </span>
                  </Link>
                </li>
              </ul>
